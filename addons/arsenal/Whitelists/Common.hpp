...
class Magazines {
    ...
    MACRO_WHITELIST(GMAGAZINE(arkanian_rifle));
    MACRO_WHITELIST(GMAGAZINE(boltblaster_rifle));
    MACRO_WHITELIST(GMAGAZINE(causality));
    MACRO_WHITELIST(GMAGAZINE(zh73));
    MACRO_WHITELIST(GMAGAZINE(westar35s));
    MACRO_WHITELIST(GMAGAZINE(westar35s_scatter));
    MACRO_WHITELIST(GMAGAZINE(a280));
    MACRO_WHITELIST(GMAGAZINE(dla13));
    MACRO_WHITELIST(GMAGAZINE(t20_rifle));
    MACRO_WHITELIST(GMAGAZINE(dc15a));
    MACRO_WHITELIST(GMAGAZINE(dc15a_gl));
    MACRO_WHITELIST(GMAGAZINE(ee2));
    MACRO_WHITELIST(GMAGAZINE(e11));
    MACRO_WHITELIST(GMAGAZINE(e11_stock));
    MACRO_WHITELIST(GMAGAZINE(e11_gl));
    MACRO_WHITELIST(GMAGAZINE(arkanian_carbine));
    MACRO_WHITELIST(GMAGAZINE(boltblaster_carbine));
    MACRO_WHITELIST(GMAGAZINE(dla13c));
    MACRO_WHITELIST(GMAGAZINE(dla13c_nostock));
    MACRO_WHITELIST(GMAGAZINE(acpr));
    MACRO_WHITELIST(GMAGAZINE(westar35c));
    MACRO_WHITELIST(GMAGAZINE(dc15s));
    MACRO_WHITELIST(GMAGAZINE(boltblaster_sniper));
    MACRO_WHITELIST(GMAGAZINE(cd35));
    MACRO_WHITELIST(GMAGAZINE(x300));
    MACRO_WHITELIST(GMAGAZINE(dc15le));
    MACRO_WHITELIST(GMAGAZINE(dw32s));
    MACRO_WHITELIST(GMAGAZINE(valken38x));
    MACRO_WHITELIST(GMAGAZINE(acpa));
    MACRO_WHITELIST(GMAGAZINE(dp23));
    MACRO_WHITELIST(GMAGAZINE(dlt19));
    MACRO_WHITELIST(GMAGAZINE(t21));
    MACRO_WHITELIST(GMAGAZINE(dc15l));
    MACRO_WHITELIST(GMAGAZINE(z6_small));
    MACRO_WHITELIST(GMAGAZINE(dh17));
...
class Vests {
    MACRO_WHITELIST(EGVEST(equipment,foundling));
    MACRO_WHITELIST(EGVEST(equipment,mandoad_battle));
    MACRO_WHITELIST(EGVEST(equipment,mandoad_heavy));
    MACRO_WHITELIST(EGVEST(equipment,mandoad_medium));
    MACRO_WHITELIST(EGVEST(equipment,mandoad_recon));
    MACRO_WHITELIST(EGVEST(equipment,mandoad_traditional));
};
