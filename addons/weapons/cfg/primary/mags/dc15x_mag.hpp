...
class GMAGAZINE(dc15x): MTI_DC15X_mag {
	scope = 2;
	author = AUTHOR;
	displayName = "[ENC] DC-15X 15rnd Magazine";
	count = 15;
...
class GMAGAZINE(dc15x_stun): MTI_DC15X_mag_tranq {
	scope = 2;
	author = AUTHOR;
	displayName = "[ENC] DC-15X 15rnd Stun Magazine";
	count = 15;
	//ammo = "ls_ammo_stun";
	ammo = "MTI_stun_ammo";
};
...
class GMAGAZINE(dc15x_ai_deraformine): MTI_DC15X_mag_Deraformine {
	scope = 2;
	author = AUTHOR;
	displayName = "[ENC] DC-15X 1rnd Deraformine A-I";
	count = 1;
...
class GMAGAZINE(dc15x_ai_latheniol): MTI_DC15X_mag_Latheniol {
	scope = 2;
	author = AUTHOR;
	displayName = "[ENC] DC-15X 1rnd Latheniol A-I";
	count = 1;
